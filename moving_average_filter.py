...
input_mat = io.loadmat('/home/cjy/Desktop/kalman example/source/2.MovAvgFilter/SonarAlt.mat')
print(input_mat)
def get_sonar(i):
    """Measure sonar."""
...
plt.savefig('/home/cjy/Desktop/kalman example/result/moving_average_filter.png')
